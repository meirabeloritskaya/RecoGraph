...
class Recipients(models.Model):
    ...
    price_range = models.CharField(max_length=25, choices=PRICE_RANGE, blank=True, null=True, help_text="Желаемый диапазон цен для подарка")
    ...
    gender = models.CharField(max_length=10, choices=GENDER_CHOICES, default='male')  # Пол обязателен
    age_range = models.CharField(max_length=20, choices=AGE_RANGE_CHOICES, default=14)  # Диапазон возраста обязателен
